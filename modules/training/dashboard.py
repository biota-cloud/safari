            ...
            rx.flex(
                ...
                rx.scroll_area(
                    rx.vstack(
                        ...
                        spacing="3",
                        width="100%",
                        # max_width prevents Radix ScrollArea's internal
                        # display:table div from expanding beyond the viewport.
                        # padding_right does NOT work here — it causes the table
                        # to grow wider (to ~452px), which then gets clipped.
                        max_width="380px",
                    ),
                    type="hover",
                    scrollbars="vertical",
